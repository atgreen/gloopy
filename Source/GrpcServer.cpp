...
namespace
{
    ...
    public:
        ...
        { const bool ok = main.apiSetSamplerControls (q->track_id(), q->start(), q->end(), q->reverse(), q->root_note(), q->fade_in(), q->fade_out());
        ...
        { const auto s = main.apiGetSamplerControls (q->id());
          ...
          r->set_fade_in (s.fadeIn); r->set_fade_out (s.fadeOut); return Status::OK; }
