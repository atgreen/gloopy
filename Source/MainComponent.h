...
public:
    ...
    bool apiSetSamplerControls (int trackId, float startFrac, float endFrac, bool reverse, int rootNote, float fadeIn, float fadeOut);
    struct SamplerSnap { bool ok { false }; float start { 0.0f }, end { 1.0f }; bool reverse { false }; int rootNote { 60 }; float fadeIn { 0.0f }, fadeOut { 0.0f }; juce::String name; };
